 ...
 */
function THEME_theme_preprocess_html(&$vars) {
  global $theme_key;
  // Load the media queries styles
  // Remember to rename these files to match the names used here - they are
  // in the CSS directory of your subtheme.
  $media_queries_css = array(
    'THEME_theme.responsive.style.css',
    'THEME_theme.responsive.gpanels.css'
  );
  load_subtheme_media_queries($media_queries_css, 'THEME_theme');
  drupal_add_js(array('THEME_theme' => array('background' => file_create_url(theme_get_setting('bg_image_path')))), 'setting');
...
function THEME_theme_preprocess_node(&$vars) {
...
function THEME_theme_process_node(&$vars) {
}
function THEME_theme_preprocess_username(&$variables) {
 ...
 */
function THEME_theme_preprocess_block(&$vars) {
...
function THEME_theme_process_block(&$vars) {
 ...
 */
function THEME_theme_preprocess_field(&$vars) {
 ...
 */
function THEME_theme_breadcrumb($vars) {
 ...
 */
function THEME_theme_preprocess_menu_link(&$variables) {
...
function THEME_theme_menu_link(array $variables) {
  $element = $variables['element'];
  $l = $element['#original_link'];
  $sub_menu = '';
  $collapse = '';
...
*/
function THEME_theme_media_gallery_item($variables) {
  ...
  if (!isset($variables['gallery'])) {
    ...
    $path = THEME_theme_get_file_scheme($url[1]);
 ...
 */
function THEME_theme_get_file_scheme($uri) {
  $uri = strtok($uri, '?');
  global $base_url;
