(function($) {
	Drupal.THEME_theme_menu = {};
	Drupal.THEME_theme_menu.animation = {show:{}, hide:{}, count:0};

	Drupal.behaviors.THEME_theme_menu = {
	 ...
	 */
	 Drupal.THEME_theme_menu.cookieSet = function() {
	 ...
	 Drupal.behaviors.backstretch = {
	 	attach: function (context, settings) {
	 		if (typeof settings.THEME_theme != 'undefined') {
	 			$.backstretch(settings.THEME_theme.background);
	 	  }
	 	}
	 };
})(jQuery);
